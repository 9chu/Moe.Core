...
static struct WidthInterval ZERO_WIDTH[] = {
...
// at commit 0d7de112202cc8b2ebe9232ff4a5c954f19d561a (2016-07-02):
static struct WidthInterval WIDE_EASTASIAN[] = {
...
{
    template <int Size>
    static bool InUnicodeTable(WidthInterval (&table)[Size], char32_t c)
    {
...
int StringUtils::GetUnicodeWidth(char32_t c)
{
    // NOTE: created by hand, there isn't anything identifiable other than
    // general Cf category code to identify these, and some characters in Cf
    // category code are of non-zero width.
    if (c == 0 || c == 0x034F || (0x200B <= c && c <= 0x200F) || c == 0x2028 || c == 0x2029 ||
        (0x202A <= c && c <= 0x202E) || (0x2060 <= c && c <= 0x2063))
    {
        return 0;
    }
    ...
    if (InUnicodeTable(ZERO_WIDTH, c))
        return 0;

    return InUnicodeTable(WIDE_EASTASIAN, c) ? 2 : 1;
}
